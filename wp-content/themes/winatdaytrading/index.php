...
<iframe width="100%" height="440" src="https://www.youtube.com/embed/DmrR6w6Bw9s?rel=0&autoplay=1" frameborder="0" allowfullscreen></iframe>                </div>

                <div class="col-lg-3 offset-lg-1 ">
                <div class="textblock">
                    <h1 align="center">Schedule My Preview</h1>
                    
                    <link href="//app.webinarjam.net/assets/css/register_button.css" rel="stylesheet"><div style="margin:auto;width:300px;"><div class="embedded-joinwebinar-button"><button type="button" class="btn btn-default css3button" title="regpopbox_38575_16331f919f"><span>Register now</span></button></div></div><script src="//cdnjs.cloudflare.com/ajax/libs/jquery/1.11.1/jquery.min.js" language="javascript" type="text/javascript"></script><script src="//app.webinarjam.net/assets/js/porthole.min.js" language="javascript" type="text/javascript" async></script><script src="//app.webinarjam.net/register.evergreen.extra.js" language="javascript" type="text/javascript" async></script>                    </div>
                    ...
                    <div class="fluid-container third-block" id="aboutsection">
                        ...
                        <div class="row ">
                            ...
                            <h2 class="wa-title margintop"> Who is DayTradeIq?</h2>
                                ...
                                Our proprietary indicators give our students the edge necessary to successfully trade in today's markets.
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="col-lg-4">
<link href="//app.webinarjam.net/assets/css/register_button.css" rel="stylesheet"><div style=""><div class="embedded-joinwebinar-button"><button type="button" class="btn btn-default css3button" title="regpopbox_38575_16331f919f"><span>Register now</span></button></div></div><script src="//cdnjs.cloudflare.com/ajax/libs/jquery/1.11.1/jquery.min.js" language="javascript" type="text/javascript"></script><script src="//app.webinarjam.net/assets/js/porthole.min.js" language="javascript" type="text/javascript" async></script><script src="//app.webinarjam.net/register.evergreen.extra.js" language="javascript" type="text/javascript" async></script>
